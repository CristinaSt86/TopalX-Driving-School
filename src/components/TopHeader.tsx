...
const TopHeader: React.FC = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-logoBlue text-white text-sm hidden custom:flex flex-col custom:flex-row justify-between items-center p-3">
