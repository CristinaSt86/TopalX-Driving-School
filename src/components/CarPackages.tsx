...
import skoda from "../images/skodaNo.png";
import fiat from "../images/fiatImg1 (1).png";
    ...
    return (
      <div ref={ref}>
        ...
        {carPackages.map((pkg, index) => (
          <section
            key={index}
            className={`mx-auto md:mx-auto flex flex-col backdrop-blur border-black border-y-2 items-center justify-around mb-16 md:flex-row ${
          ...
          >
            ...
            <div className="w-full md:w-1/2 flex justify-center">
              <img
                src={pkg.image}
                alt={pkg.name}
                className="bg-secondary w-full h-full max-w-lg md:max-w-lg object-cover pr-20 pl-20 md:mx-auto"
              />
            </div>
          </section>
        ))}
