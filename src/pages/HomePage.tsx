  ...
  return (
    <div id="home" className="overflow-x-hidden max-w-full mx-auto">
      ...
      >
        ...
        {/* Text Content */}
        <div
          className={`relative z-10 mt-8 text-xl sm:text-4xl font-extrabold mb-4 sm:mb-10 leading-normal bg-customTextBg w-fit rounded-md px-2 ${
            animate ? "slide-in" : ""
          }`}
        >
          <h1>
        ...
        <p
          className={`relative z-10 text-lg sm:text-2xl md:text-4xl mt-2 sm:mt-4 md:leading-normal -tracking-normal bg-customTextBg w-fit rounded-md ${
            animate ? "slide-in" : ""
          }`}
        >
          {t("home.description")}
