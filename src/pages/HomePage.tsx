...
const HomePage: React.FC = () => {
  ...
  return (
    <div>
      <div
        className={`flex flex-col items-center justify-center shadow-custom pt-12 sm:pt-16 pb-48 mt-0 bg-custom-home text-white px-4 sm:p-16 text-center mb-8 h-auto md:pt-24 md:pb-48`}
      >
        <h1
